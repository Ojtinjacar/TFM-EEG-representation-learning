...
@pytest.mark.parametrize("name", [
    ...
    "InterFusion-interfusion_c1a_parietal_all_cit_36mo_fold3.csv",
])
...
def test_an_interfusion_label_keeps_its_tag_as_the_variant():
    out = cr.normalise("InterFusion-interfusion_c1a")
    assert out["family"] == "InterFusion"
    assert out["variant"] == "InterFusion-interfusion_c1a"
