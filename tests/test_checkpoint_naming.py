...
def test_vae_name_contract():
    assert vae_checkpoint_name(
        "VAE", "all", "all", "fold0", beta=0.003, prior="standard", free_bits=0.0
...
def test_expclr_name_contract():
    assert expclr_checkpoint_name(
        ...
        temperature=0.5, delta=1.0,
    ) == "ExpCLR_all_all_fold0_P_full_batch_64_lr_0.005_tau_0.5_delta_1.0.pth"
